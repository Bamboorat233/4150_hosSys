...
(9, 7, 28),
(10, 3, 20);
INSERT INTO dbo.[User] (Username, [Password], Role,  Email, CreatedDate, IsActive)
VALUES 
    (N'admin', N'admin123', N'Admin', N'admin@hospital.com', GETDATE(), 1),
    (N'doctor1', N'doc123', N'Doctor', N'doctor1@hospital.com', GETDATE(), 1),
    (N'nurse1', N'nurse123', N'Nurse', N'nurse1@hospital.com', GETDATE(), 1),
    (N'reception1', N'rec123', N'Receptionist', N'reception1@hospital.com', GETDATE(), 1);
